                                ...
                                <div class="p-2 w-full">
                                    <div class="relative">
                                        ...
                                        <select name="age">
                                            ...
                                            <option value="1" {{ old ('gender') == 1 ? 'selected' : ''}}>~19歳</option>
                                            <option value="2" {{ old ('gender') == 2 ? 'selected' : ''}}>20歳~29歳</option>
                                            <option value="3" {{ old ('gender') == 3 ? 'selected' : ''}}>30歳~39歳</option>
                                            <option value="4" {{ old ('gender') == 4 ? 'selected' : ''}}>40歳~49歳</option>
                                            <option value="5" {{ old ('gender') == 5 ? 'selected' : ''}}>50歳~59歳</option>
                                            <option value="6" {{ old ('gender') == 6 ? 'selected' : ''}}>60歳~</option>
                                        </select>
                                    </div>
                                </div>
